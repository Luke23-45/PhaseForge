...
Usage::
    ...
    uv run python scripts/local_run.py train models=precision_residual_phaseforge train=stage1 ...
    uv run python scripts/local_run.py eval  models=precision_residual_phaseforge eval=rollout ...
"""
