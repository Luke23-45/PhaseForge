...
Authoritative direction for the PhaseForge research. Files are organized into
three subdirectories by role. Code and other docs cross-reference these paths,
so renames here require updating references.
...
## design/ — Design & paper source material
